...
var RadioButton = (function (_super) {
    ...
    RadioButton.prototype.render = function () {
        ...
        return (react_1.default.createElement("li", { key: id, id: id, role: "radio", "aria-checked": checked, "aria-disabled": disabled || optionDisabled, "data-value": value, onClick: this.handleClick, className: hasFocus ? 'radio-focus' : '' },
            react_1.default.createElement("span", null, label),
            RadioContent && react_1.default.createElement(RadioContent, null)));
    };
    return RadioButton;
}(react_1.Component));
