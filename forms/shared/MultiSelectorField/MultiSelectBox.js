...
var MultiSelectBox = (function (_super) {
    ...
    MultiSelectBox.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "multi-select-box" },
            react_1.default.createElement("ul", { tabIndex: 0, onKeyDown: this.handleKeyDown, onKeyPress: this.handleKeyPress, ref: function (el) { return _this.ulRef = el; } }, this.props.selectItems.map(function (selectItem) {
                return react_1.default.createElement("li", { key: selectItem.id, tabIndex: 0, className: _this.isSelected(selectItem.id) ? 'selected' : '', onClick: handleOnClick(selectItem.id), ref: function (el) {
                        if (el !== null) {
