...
function startBlockingCall() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, effects_1.select(selectors_1.getBlockingCalls)];
            case 1:
                counter = _a.sent();
                _a.label = 2;
            case 2:
                ...
                return [4, effects_1.call(redux_saga_1.delay, 500)];
            case 3:
                _a.sent();
                _a.label = 4;
            case 4: return [3, 7];
            case 5: return [4, effects_1.put(actions_1.incrementBlockingCounter())];
            case 6:
                _a.sent();
                return [7];
            case 7: return [2];
...
exports.startBlockingCall = startBlockingCall;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, effects_1.call(redux_saga_1.delay, 3000)];
            case 1:
                _b.sent();
                return [4, effects_1.select(selectors_1.getMessages)];
            case 2:
                messages = _b.sent();
            ...
            case 4:
                ...
                return [4, effects_1.put(actions.hideMessage(hideMessageAction))];
            case 5:
                _b.sent();
                _b.label = 6;
            case 6:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, effects_1.select(selectors_1.getActiveSpinners)];
            case 1:
                spinners = _a.sent();
            ...
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4, effects_1.put(actions_1.addSpinnerFor(payload))];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5: return [2];
...
function watchStartBlockingCall() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, effects_1.takeLatest(t.START_BLOCKING_CALL, startBlockingCall)];
            case 1:
                _a.sent();
                return [2];
        }
...
function watchShowMessage() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, effects_1.takeLatest(t.SHOW_MESSAGE, showMessage)];
            case 1:
                _a.sent();
                return [2];
        }
...
function watchStartSpinner() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, effects_1.takeEvery(t.START_SPINNER, startSpinner)];
            case 1:
                _a.sent();
                return [2];
        }
